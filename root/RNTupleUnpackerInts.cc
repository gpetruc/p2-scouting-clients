...
UnpackerBase::Report RNTupleUnpackerInts::unpack(const std::vector<std::string> &ins, const std::string &out) const {
  Data data;

  auto makeModel = [](ROOT::Experimental::RNTupleModel &model, Data &d) {
    d.p_npuppi = model.MakeField<uint8_t>("nPuppi");
    d.p_pt = model.MakeField<std::vector<uint16_t>>("Puppi_pt");
    d.p_eta = model.MakeField<std::vector<int16_t>>("Puppi_eta");
    d.p_phi = model.MakeField<std::vector<int16_t>>("Puppi_phi");
    d.p_pid = model.MakeField<std::vector<uint8_t>>("Puppi_pid");
    d.p_z0 = model.MakeField<std::vector<int16_t>>("Puppi_z0");
    d.p_dxy = model.MakeField<std::vector<int8_t>>("Puppi_dxy");
    d.p_quality = model.MakeField<std::vector<uint8_t>>("Puppi_quality");
    d.p_wpuppi = model.MakeField<std::vector<uint16_t>>("Puppi_wpuppi");
  };
